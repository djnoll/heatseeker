...
*/
(function(t, e) {
  L.drawVersion = "0.2.0-dev", L.drawLocal = {
    draw: {
      toolbar: {
    ...
    _getTooltipText: function() {
      var t, e;
      return 0 === this._markers.length ? t = L.drawLocal.draw.polygon.tooltip.start : 3 > this._markers.length ? t = L.drawLocal.draw.polygon.tooltip.cont : (t = L.drawLocal.draw.polygon.tooltip.end, e = this._area), {
        text: t,
        subtext: e
      }
    },
    ...
    _vertexAdded: function() {
      if (!this.options.allowIntersection && this.options.showArea) {
        var t = this._poly.getLatLngs(),
          e = L.PolygonUtil.geodesicArea(t);
